    ...
    <div class="container" id="intro-text">
        <div class="d-flex justify-content-between">
            <div id ="card-info" class="p-2 mt-5 mb-5" >
                ...
                <div id="landing-text">
                    <p>Poskytuji služby v oblasti podnikových informačních systémů. Mým cílem je navrhnout a spravovat spolehlivou infrastrukturu informačních, která pokrývá celou řadu požadavků stanovených IT strategií.</p>
                </div>
            </div>
